        ...
        <div className="privacy-content">
          ...
          <div className="privacy-sections">
            ...
            <section id="cookies" className="scroll-animation">
              ...
              <ul>
                <li><strong>Essential Cookies:</strong> These cookies are necessary for the basic functionality of our website, such as keeping you logged in, remembering your preferences, and ensuring security. These cookies do not collect personal information and cannot be disabled as they are required for the website to function properly.</li>
                <li><strong>Analytical/Performance Cookies:</strong> These cookies help us understand how visitors interact with our website by collecting anonymous information about which pages you visit, how long you spend on the site, and if you experience any errors. This data helps us improve our website's performance and usability.</li>
                <li><strong>Functionality Cookies:</strong> These cookies enable personalized features and remember your preferences (such as language settings, font size, or dark mode preferences) to provide you with an enhanced and customized experience.</li>
                <li><strong>Targeting/Advertising Cookies:</strong> These cookies are used to deliver relevant advertisements and track the effectiveness of our marketing campaigns. They may also be used to limit the number of times you see an advertisement and help measure the effectiveness of advertising campaigns.</li>
              </ul>
              <h3>Managing Your Cookie Preferences</h3>
              <p>
                When you first visit our website, you will be presented with a cookie consent banner that allows you to choose which types of cookies you accept. You can change your preferences at any time by clicking on the "Cookie Settings" link in the footer of our website.
              </p>
              <p>
                You can also control cookies through your browser settings. Most web browsers allow you to manage your cookie preferences by:
              </p>
              <ul>
                <li>Deleting all cookies from your browser</li>
                <li>Blocking all cookies or only third-party cookies</li>
                <li>Allowing all cookies or only certain websites to set cookies</li>
              </ul>
              <p>
                Please note that if you choose to block certain cookies, you may not be able to use all the features of our Services, and some functions might not work properly.
              </p>
              <h3>Third-Party Cookies</h3>
              <p>
                Some cookies are placed by third parties on our website. These third parties may include analytics providers (like Google Analytics), advertising networks, and social media platforms. We do not control these third parties or their cookies. For information about how these third parties use cookies, please refer to their respective privacy policies.
              </p>
              <h3>Do Not Track Signals</h3>
              <p>
                Some browsers have a "Do Not Track" feature that lets you tell websites that you do not want to have your online activities tracked. Our system currently does not respond to these signals. However, you can express your preferences regarding cookies through our cookie consent banner or your browser settings.
              </p>
            </section>
